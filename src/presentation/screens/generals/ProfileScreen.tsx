...
export default function ProfileScreen() {
  ...
  // El registro del conjunto guarda todo en mayúsculas; se muestra en dos
  // líneas —nombres arriba, apellidos abajo— porque los nombres compuestos no
  // caben en una sola y quedaban recortados.
  const givenNames = formatName(resident?.user.name);
  const surnames = formatName(resident?.user.lastName);
